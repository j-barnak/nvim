...
Create the \$HOME/embedded-linux-bbb-labs/kernel directory and go into it.
...
However, this requires downloading more than 2.8 GB of data. If you are running this command from home, or if you have very fast access to the Internet at work (and if you are not 256 participants in the training

room), you can do it directly by connecting to [https://git.kernel.org:](https://git.kernel.org)

git clone https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux cd linux
