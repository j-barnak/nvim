...
![Address types used in Linux](/tmp/audit/iter1/epubregen/linux-device-drivers-3rd-edition/media/httpatomoreillycomsourceoreillyimages138419.png)
...
`nents, enum dma_data_direction direction);`  
*dma_map_sg* maps a scatter/gather operation, and *dma_unmap_sg* undoes that mapping. If the buffers must be accessed while the mapping is active, *dma_sync_sg\_\** may be used to synchronize things.
