...
As an alternative, you can use the *kgdb* patch found on [http://kgdb.sf.net/](http://kgdb.sf.net/). This version of the debugger does not support the network communication mode (though that is said to be under development), but it does have some built-in support for working with loadable modules. It supports the x86, x86_64, PowerPC, and S/390 architectures.
...
See [http://user-mode-linux.sf.net/](http://user-mode-linux.sf.net/) for more information on UML.
