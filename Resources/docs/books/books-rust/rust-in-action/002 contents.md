...
*24* ■ *Resource-constrained environments*
...
*with base 2, base 8, and base 16 notation*

*37* ■ *Comparing*

*numbers*

*38* ■ *Rational, complex numbers, and other numeric*
...
*45* ■ *Continue: Skipping the rest*

*of the current iteration*

*47* ■ *While: Looping until a condition*

*changes its state*

*47* ■ *Loop: The basis for Rust’s looping*

*constructs*

*48* ■ *Break: Aborting a loop*

*48* ■ *If, if else, and*

*else: Conditional branching*

*49* ■ *Match: Type-aware pattern*
...
*68* ■ *Generating the third-*

*party crate documentation locally*

*69* ■ *Managing Rust toolchains*
...
*98* ■ *Implementing std::fmt::Display for*
...
**DEMYSTIFYING SYSTEMS PROGRAMMING ...........135**
...
*144* ■ *Isolating the sign bit*

*146*

*Isolating the exponent*

*146* ■ *Isolate the mantissa*
...
Generating random probabilities from random
...
*159* ■ *Full code listing for CPU RIA/1:*

*The Adder*

*163* ■ *CPU RIA/2: The Multiplier*

*164* ■ *CPU*

*RIA/3: The Caller*

*167* ■ *CPU 4: Adding the rest*
...
*190* ■ *What is dynamic memory*

*allocation?*

*194* ■ *Analyzing the impact of dynamic memory*
...
*202* ■ *Step 1: Having a process scan its own*

*memory*

*203* ■ *Translating virtual addresses to physical*

*addresses*

*205* ■ *Step 2: Working with the OS to scan an*

*address space*

*208* ■ *Step 3: Reading from and writing to*
...
*222* ■ *Introducing actionkv v1: An*

*in-memory key-value store with a command-line interface*
...
Understanding the core of actionkv: The libactionkv
...
*228* ■ *Processing an individual*

*record*

*230* ■ *Writing multi-byte binary data to disk in a*

*guaranteed byte order*

*232* ■ *Validating I/O errors with*

*checksums*

*234* ■ *Inserting a new key-value pair into an*

*existing database*

*236* ■ *The full code listing for actionkv*
...
*to decide between HashMap and BTreeMap*

*245* ■ *Adding a*

*database index to actionkv v2.0*
...
*downstream errors by defining our own error type*
...
clock v0.1.0: Teaching an application how to tell
...
clock v0.1.1: Formatting timestamps to comply with ISO
...
*301* ■ *Providing a full command-line*

*interface*

*301* ■ *clock v0.1.1: Full project*
...
*306* ■ *Setting the time for operating systems that*

*use libc*

*306* ■ *Setting the time on MS Windows*

*308* ■ *clock*

*v0.1.2: The full code listing*
...
clock v0.1.3: Resolving differences between clocks with the
...
*the local time as a result of the server’s response*

*316* ■ *Converting*

*between time representations that use different precisions and*

*epochs*

*318* ■ *clock v0.1.3: The full code listing*
...
*330* ■ *Spawning a thread*

*331*

*Effect of spawning a few threads*

*331* ■ *Effect of spawning*

*many threads*

*333* ■ *Reproducing the results*
...
*threaded render-hex overview*

*342* ■ *Spawning a thread per*

*logical task*

*351* ■ *Using a thread pool and task queue*
...
*Setting up a development environment for developing an*

*OS kernel*

*366* ■ *Verifying the development environment*
...
*374* ■ *Writing to the screen with*

*VGA-compatible text mode*

*375* ■ *\_start(): The main() function for*
...
*395* ■ *Suspend and resume a program’s*

*operation*

*397* ■ *Listing all signals supported by the OS*
...
*401* ■ *Using a global variable to indicate*
...
*409* ■ *Setting up intrinsics in a*

*program*

*409* ■ *Casting a pointer to another type*

*412*

*Compiling the sjlj project*

*413* ■ *sjlj project source code*

*414*

12.10

A note on applying these techniques to platforms without
