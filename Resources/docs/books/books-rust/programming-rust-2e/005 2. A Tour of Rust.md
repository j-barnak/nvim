...
![Web page offering to compute GCD](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0201.png "Web page offering to compute GCD")
...
![Web page showing results of computing GCD](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0202.png "Web page showing results of computing GCD")
...
![real number line, showing effect of repeated squaring on various numbers](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0203.png)
...
![(The complex points \`upper_left\` and \`lower_right\` mark two opposite corners of a rectangle. The rectangle is divided into \`bounds.0\` columns and \`bounds.1\` rows of pixels. The upper left pixel is row 0, column 0, and the lower right pixel is row \`bounds.0 - 1\`, column \`bounds.1 - 1\`.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0204.png)
...
![(Using a vector as a rectangular array of pixels. The width is bounds.0, the height bounds.1. Elements 0 through bounds.0-1 are the top row of pixels. Element bounds.0\*bounds.1-1 is the bottom right pixel.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0205.png)
...
![Results from parallel Mandelbrot program](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0206.png "Results from parallel Mandelbrot program")
...
![(Dividing the pixel buffer into horizontal bands. The first thread renders the top band, the second thread the band below that, and so on.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0207.png)
