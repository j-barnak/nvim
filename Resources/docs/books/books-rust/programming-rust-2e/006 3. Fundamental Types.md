...
![(Diagram of a floating-point literal, showing integer part, fractional part, exponent, and type suffix.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0301.png)
...
![borrowing a slice of a vector](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0302.png)
...
![(A String owns its buffer. A &str is a fat pointer to someone else's characters.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_0303.png)
