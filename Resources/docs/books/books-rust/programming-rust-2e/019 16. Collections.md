...
![(An illustration of a hash table with 16 slots, 13 of them occupied.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1604.png)
...
![(An illustration of how BTreeMaps are stored in memory. A \`BTreeMap\`'s data is stored in nodes. Each node holds a limited number of key-value pairs.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1605.png)
