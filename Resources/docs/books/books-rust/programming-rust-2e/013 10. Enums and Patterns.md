...
![Diagram showing how the fields of various RoughTime values fit in 8 bytes of memory.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1001.png)
...
![Diagram showing how the fields of various Json values fit in 4 words of memory.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1002.png)
...
![Diagram showing how BinaryTree is arranged in memory.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1003.png)
...
![An InTheFuture value doesn't match an InThePast pattern.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1004.png)
...
![An InTheFuture value matches an InTheFuture pattern. The value 'TimeUnit::Months' matches the identifier 'units', and the value 1 matches the identifier 'count'.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1005.png)
...
![A Point fails to match the first pattern, but matches the second.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1006.png)
...
![A reference to a Point3d matches an & pattern.](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_1007.png)
