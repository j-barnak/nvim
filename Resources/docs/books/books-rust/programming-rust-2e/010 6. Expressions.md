...
| Control flow expressions | `if ok { 1 } else { 0 }`                  |                                                                        |
| Control flow expressions | `if let Some(x) = f() { x } else { 0 }`   |                                                                        |
| Control flow expressions | `match x { None => 0, _ => 1 }`           |                                                                        |
| Control flow expressions | `for v in e { f(v); }`                    | `std::iter::IntoIterator`                                              |
| Control flow expressions | `while ok { ok = f(); }`                  |                                                                        |
| Control flow expressions | `while let Some(x) = it.next() { f(x); }` |                                                                        |
| Control flow expressions | `loop { next_event(); }`                  |                                                                        |
| Control flow expressions | `break`                                   |                                                                        |
| Control flow expressions | `continue`                                |                                                                        |
| Control flow expressions | `return 0`                                |                                                                        |
...
| Compound assignment      | `x /= 1`                                  | `DivAssign`                                                            |
| Compound assignment      | `x %= 1`                                  | `RemAssign`                                                            |
| Compound assignment      | `x += 1`                                  | `AddAssign`                                                            |
| Compound assignment      | `x -= 1`                                  | `SubAssign`                                                            |
| Compound assignment      | `x <<= 1`                                 | `ShlAssign`                                                            |
| Compound assignment      | `x >>= 1`                                 | `ShrAssign`                                                            |
| Compound assignment      | `x &= 1`                                  | `BitAndAssign`                                                         |
| Compound assignment      | `x ^= 1`                                  | `BitXorAssign`                                                         |
| Compound assignment      | `x \|= 1`                                  | `BitOrAssign`                                                          |
| Closure                  | `\|x, y\| x + y`                            |                                                                        |
