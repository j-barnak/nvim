...
![listing of assert_eq! macro with pattern and template labeled](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_2101.png)
...
![(Illustration of matching the arguments 'gcd(6, 10), 2' with the pattern '\$left:expr , \$right:expr'.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_2102.png)
...
![(Image showing the template and where code fragments are plugged in.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_2103.png)
...
![(Picture of a struct with a \#\[derive(IntoJson)\] attibute.)](/tmp/audit/iter1/epubregen/programming-rust-2e/media/Images/pr2e_2104.png)
