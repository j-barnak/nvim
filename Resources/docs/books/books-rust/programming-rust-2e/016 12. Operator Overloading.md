...
| Unary operators                          | `std::ops::Not`          | `!x`                                |
| Arithmetic operators                     | `std::ops::Add`          | `x + y`                             |
| Arithmetic operators                     | `std::ops::Sub`          | `x - y`                             |
| Arithmetic operators                     | `std::ops::Mul`          | `x * y`                             |
| Arithmetic operators                     | `std::ops::Div`          | `x / y`                             |
| Arithmetic operators                     | `std::ops::Rem`          | `x % y`                             |
| Bitwise operators                        | `std::ops::BitAnd`       | `x & y`                             |
| Bitwise operators                        | `std::ops::BitOr`        | `x \| y`                             |
| Bitwise operators                        | `std::ops::BitXor`       | `x ^ y`                             |
| Bitwise operators                        | `std::ops::Shl`          | `x << y`                            |
| Bitwise operators                        | `std::ops::Shr`          | `x >> y`                            |
| Compound assignment arithmetic operators | `std::ops::AddAssign`    | `x += y`                            |
| Compound assignment arithmetic operators | `std::ops::SubAssign`    | `x -= y`                            |
| Compound assignment arithmetic operators | `std::ops::MulAssign`    | `x *= y`                            |
| Compound assignment arithmetic operators | `std::ops::DivAssign`    | `x /= y`                            |
| Compound assignment arithmetic operators | `std::ops::RemAssign`    | `x %= y`                            |
| Compound assignment bitwise operators    | `std::ops::BitAndAssign` | `x &= y`                            |
| Compound assignment bitwise operators    | `std::ops::BitOrAssign`  | `x \|= y`                            |
| Compound assignment bitwise operators    | `std::ops::BitXorAssign` | `x ^= y`                            |
| Compound assignment bitwise operators    | `std::ops::ShlAssign`    | `x <<= y`                           |
| Compound assignment bitwise operators    | `std::ops::ShrAssign`    | `x >>= y`                           |
| Comparison                               | `std::cmp::PartialEq`    | x == y , x != y                     |
| Comparison                               | `std::cmp::PartialOrd`   | x \< y , x \<= y , x \> y , x \>= y |
| Indexing                                 | `std::ops::Index`        | x\[y\] , &x\[y\]                    |
| Indexing                                 | `std::ops::IndexMut`     | x\[y\] = z , &mut x\[y\]            |
...
| Arithmetic operators | `std::ops::Sub`    | `x - y`    | `x.sub(y)`            |
| Arithmetic operators | `std::ops::Mul`    | `x * y`    | `x.mul(y)`            |
| Arithmetic operators | `std::ops::Div`    | `x / y`    | `x.div(y)`            |
| Arithmetic operators | `std::ops::Rem`    | `x % y`    | `x.rem(y)`            |
| Bitwise operators    | `std::ops::BitAnd` | `x & y`    | `x.bitand(y)`         |
| Bitwise operators    | `std::ops::BitOr`  | `x \| y`    | `x.bitor(y)`          |
| Bitwise operators    | `std::ops::BitXor` | `x ^ y`    | `x.bitxor(y)`         |
| Bitwise operators    | `std::ops::Shl`    | `x << y`   | `x.shl(y)`            |
| Bitwise operators    | `std::ops::Shr`    | `x >> y`   | `x.shr(y)`            |
...
| Arithmetic operators | `std::ops::SubAssign`    | `x -= y`   | `x.sub_assign(y)`     |
| Arithmetic operators | `std::ops::MulAssign`    | `x *= y`   | `x.mul_assign(y)`     |
| Arithmetic operators | `std::ops::DivAssign`    | `x /= y`   | `x.div_assign(y)`     |
| Arithmetic operators | `std::ops::RemAssign`    | `x %= y`   | `x.rem_assign(y)`     |
| Bitwise operators    | `std::ops::BitAndAssign` | `x &= y`   | `x.bitand_assign(y)`  |
| Bitwise operators    | `std::ops::BitOrAssign`  | `x \|= y`   | `x.bitor_assign(y)`   |
| Bitwise operators    | `std::ops::BitXorAssign` | `x ^= y`   | `x.bitxor_assign(y)`  |
| Bitwise operators    | `std::ops::ShlAssign`    | `x <<= y`  | `x.shl_assign(y)`     |
| Bitwise operators    | `std::ops::ShrAssign`    | `x >>= y`  | `x.shr_assign(y)`     |
