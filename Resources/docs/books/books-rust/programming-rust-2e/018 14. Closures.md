...
![Picture showing three closures labeled (a), (b), and (c).](media/Images/pr2e_1401.png)
...
![Picture showing Fn as the innermost circle, enclosed by FnMut, which is enclosed by FnOnce.](media/Images/pr2e_1402.png)
...
![Graph showing three objects, connected by arrows. Some of the arrows are labeled 'via callback'.](media/Images/pr2e_1403.png)
...
![Graph showing four boxes: Action, Dispatcher, Store, View. A user is also shown. Arrows point in a loop from user input, through the four boxes in order, to the user's display.](media/Images/pr2e_1404.png)
