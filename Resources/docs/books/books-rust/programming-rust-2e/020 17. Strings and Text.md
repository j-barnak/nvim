...
![(UTF-8 encodes Unicode code points using one through four bytes.)](media/Images/pr2e_1701.png)
...
![(examples of encoding the characters '\*', Greek mu, Japanese 'sabi', and the crab emoji in UTF-8)](media/Images/pr2e_1702.png)
...
![(A sample text, and the items various iterators would produce when applied to it.)](media/Images/pr2e_1703.png)
