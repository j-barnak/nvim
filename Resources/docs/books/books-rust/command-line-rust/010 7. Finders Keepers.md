...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO1-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO2-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO2-2)  
The `-n|--name` option can specify one or more patterns.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO2-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO3-1)  
The [`regex::Regex`](https://oreil.ly/8PrIh) struct will represent a compiled regular expression.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO3-2)  
`paths` will be a vector of strings and may name files or directories.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO3-3)  
`names` will be a vector of regular expressions.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_finders_keepers_CO3-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO4-1)  
The `value_variants` method returns the allowed variants.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO4-2)  
...
![clru 0701](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_0701.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO5-1)  
The `paths` argument requires at least one value and defaults to a dot (`.`).

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO5-2)  
The `names` option accepts zero or more values that must parse to a valid regex.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO5-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO6-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO7-1)  
Each directory entry is returned as a `Result`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO7-2)  
Print errors to `STDERR`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO7-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO8-1)  
Check if no entry types are indicated.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO8-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO8-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO9-1)  
Check the entry type as before.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO9-2)  
Combine the entry type check using `&&` with a similar check on the given names.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO9-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO10-1)  
Create a closure to filter entries on `any` of the regular expressions.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO10-2)  
Create a similar closure to filter entries by `any` of the types.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO10-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_finders_keepers_CO10-4)  
Filter out unwanted types.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_finders_keepers_CO10-5)  
Filter out unwanted names.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_finders_keepers_CO10-6)  
Turn each [`DirEntry`](https://oreil.ly/F0xri) into a string to display.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_finders_keepers_CO10-7)  
Use [`Iterator::collect`](https://oreil.ly/Xn28H) to create a vector.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_finders_keepers_CO10-8)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO11-1)  
Return `true` immediately if no entry types have been indicated.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO11-2)  
Otherwise, iterate over the `args.entry_types` to compare to the given entry type.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO11-3)  
When the entry type is `Link`, use the `DirEntry::file_type` function to call [`FileType::is_symlink`](https://oreil.ly/6_XUV).

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_finders_keepers_CO11-4)  
When the entry type is `Dir`, similarly use [`FileType::is_dir`](https://oreil.ly/Cmkjx).

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_finders_keepers_CO11-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO12-1)  
Return `true` immediately if no name regexes are present.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO12-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO13-1)  
The function accepts the command-line arguments and the file containing the expected output.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO13-2)  
Decide whether to use the file for Unix or Windows, which will be explained shortly.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO13-3)  
Read the contents of the expected file, then split and sort the lines.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_finders_keepers_CO13-4)  
Run the program with the arguments, assert it runs successfully, then split and sort the lines of output.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_finders_keepers_CO13-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_finders_keepers_CO14-1)  
Define and create the directory.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_finders_keepers_CO14-2)  
Set the permissions to make the directory unreadable.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_finders_keepers_CO14-3)  
Run `findr` and assert that it does not fail.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_finders_keepers_CO14-4)  
Remove the directory so that it does not interfere with future tests.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_finders_keepers_CO14-5)  
Split the lines of `STDOUT`.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_finders_keepers_CO14-6)  
Verify there are 17 lines.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_finders_keepers_CO14-7)  
