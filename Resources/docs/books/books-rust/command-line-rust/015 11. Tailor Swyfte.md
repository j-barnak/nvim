...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO1-1)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO2-1)  
`files` is a vector of strings.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO2-2)  
`lines` should default to “10” to indicate the last 10 lines.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO2-3)  
`bytes` is an optional number of bytes to select.

[![4](media/assets/4.png)](#co_tailor_swyfte_CO2-4)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO3-1)  
The positional argument goes into `files`.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO3-2)  
The `lines` argument should default to “10” to take the last 10 lines.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO3-3)  
The `bytes` argument should default to `None`.

[![4](media/assets/4.png)](#co_tailor_swyfte_CO3-4)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO4-1)  
The positional arguments are parsed as `files`.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO4-2)  
The `lines` argument is still set to the default.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO4-3)  
Now `bytes` is set to `Some("4")` to indicate the last four bytes should be taken.

[![4](media/assets/4.png)](#co_tailor_swyfte_CO4-4)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO5-1)  
The `files` argument is positional and requires at least one value.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO5-2)  
The `lines` argument has a default value of `10`.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO5-3)  
The `bytes` argument is optional and conflicts with `lines`.

[![4](media/assets/4.png)](#co_tailor_swyfte_CO5-4)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO6-1)  
The `PartialEq` is needed by the tests to compare values.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO6-2)  
This variant represents an argument of `+0`.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO6-3)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO7-1)  
The `+5` argument indicates the program should start printing on the fifth line.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO7-2)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO8-1)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO10-1)  
...
[![2](media/assets/2.png)](#co_tailor_swyfte_CO10-2)  
...
[![3](media/assets/3.png)](#co_tailor_swyfte_CO10-3)  
...
[![4](media/assets/4.png)](#co_tailor_swyfte_CO10-4)  
...
[![5](media/assets/5.png)](#co_tailor_swyfte_CO10-5)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO11-1)  
The `file` argument should implement the `BufRead` trait.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO11-2)  
The `num_lines` argument is a `TakeValue` describing the number of lines to print.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO11-3)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO12-1)  
The generic type `T` has the trait bounds `Read` and `Seek`.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO12-2)  
The `file` argument must implement the indicated traits.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO12-3)  
The `num_bytes` argument is a `TakeValue` describing the byte selection.

[![4](media/assets/4.png)](#co_tailor_swyfte_CO12-4)  
...
[![4](media/assets/4.png)](#co_tailor_swyfte_CO13-4)  
When no bytes were read, exit the loop.

[![5](media/assets/5.png)](#co_tailor_swyfte_CO13-5)  
Increment the line count.

[![6](media/assets/6.png)](#co_tailor_swyfte_CO13-6)  
...
[![7](media/assets/7.png)](#co_tailor_swyfte_CO13-7)  
Clear the buffer before reading the next line.

[![8](media/assets/8.png)](#co_tailor_swyfte_CO13-8)  
...
[![3](media/assets/3.png)](#co_tailor_swyfte_CO14-3)  
...
[![4](media/assets/4.png)](#co_tailor_swyfte_CO14-4)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO15-1)  
...
[![2](media/assets/2.png)](#co_tailor_swyfte_CO15-2)  
Initialize variables for counting and reading lines from the file.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO15-3)  
Check if the given line is at or beyond the starting point.

[![4](media/assets/4.png)](#co_tailor_swyfte_CO15-4)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO16-1)  
Count the total lines and bytes in the current file.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO16-2)  
Create a `BufReader` with the opened filehandle.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO16-3)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO17-1)  
See if there is a valid starting byte position.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO17-2)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO18-1)  
Check if the user has requested a byte selection.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO18-2)  
If so, print the selected bytes.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO18-3)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO19-1)  
Find the number of files.

[![2](media/assets/2.png)](#co_tailor_swyfte_CO19-2)  
Use `Iterator::enumerate` to iterate through the index positions and filenames.

[![3](media/assets/3.png)](#co_tailor_swyfte_CO19-3)  
...
[![1](media/assets/1.png)](#co_tailor_swyfte_CO20-1)  
