...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO1-1)  
Functions are defined using `fn`. The name of this function is `main`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO1-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO1-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO2-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO3-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO4-1)  
Change into the parent directory, which is indicated with two dots (`..`).

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO4-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO5-1)  
*Cargo.toml* is a configuration file for the project. The extension *.toml* stands for Tom’s Obvious, Minimal Language.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO5-2)  
The *src* directory is for Rust source code files.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO5-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO6-1)  
The first three lines are information about what Cargo is doing.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO6-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO7-1)  
This was the name of the project I created with Cargo, so it will also be the name of the executable.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO7-2)  
This is the version of the program.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO7-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_truth_or_consequences_CO7-4)  
This is a comment line that I will include only this one time. You can remove this line from your file, if you like.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_truth_or_consequences_CO7-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO8-1)  
The `#[test]` attribute tells Rust to run this function when testing.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO8-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO9-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO9-2)  
The *src* directory is for the Rust source code files to build the program.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO9-3)  
The *target* directory holds the build artifacts.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_truth_or_consequences_CO9-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO10-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO10-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO10-3)  
Run the command and capture the output, which will be a [`Result`](https://oreil.ly/EYxds).

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_truth_or_consequences_CO10-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO11-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO12-1)  
Import `assert_cmd::Command`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO12-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO12-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO13-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO14-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO15-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO16-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_truth_or_consequences_CO17-1)  
Import the `pretty_assertions::assert_eq` macro for comparing values instead of the standard Rust version.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_truth_or_consequences_CO17-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_truth_or_consequences_CO17-3)  
Verify that the command succeeded.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_truth_or_consequences_CO17-4)  
Convert the output of the program to UTF-8, which I’ll discuss more in Chapter 4.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_truth_or_consequences_CO17-5)  
