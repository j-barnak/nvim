...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO1-1)  
`chrono` will be used to handle the file modification times.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO1-2)  
`tabular` will be used to present a text table for the long listing.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO1-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO2-1)  
The `paths` argument will be a vector of strings for files and directories.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO2-2)  
The `long` option is a Boolean for whether or not to print the long listing.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO2-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO3-1)  
`paths` is a vector of file or directory names from the user.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO3-2)  
`show_hidden` indicates whether or not to include hidden files in directory listings.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO3-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#manual_co_elless_island_CO4-1)  
Look for the entries in the *tests/inputs* directory, ignoring hidden files.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#manual_co_elless_island_CO4-2)  
Ensure that the result is an `Ok` variant.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#manual_co_elless_island_CO4-3)  
Collect the display names into a `Vec<String>`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#manual_co_elless_island_CO4-4)  
Sort the entry names in alphabetical order.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#manual_co_elless_island_CO4-5)  
Verify that the four expected files were found.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#manual_co_elless_island_CO4-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO4-1)  
Include hidden files in the results.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO4-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO5-1)  
Look for the files in the provided paths and specify whether to show hidden entries.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO5-2)  
Iterate through each of the returned paths.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO5-3)  
...
![clru 1401](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_1401.png)
...
![clru 1402](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_1402.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO6-1)  
The `..=` range operator includes the ending value.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO6-2)  
...
![clru 1403](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_1403.png)
...
![clru 1404](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_1404.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO7-1)  
Import the `format_mode` function.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO7-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO8-1)  
The function takes a line of the output along with the expected values for the permissions, size, and path.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO8-2)  
Split the line of text on whitespace.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO8-3)  
Verify that the line was split into an expected range of fields.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO8-4)  
Verify the permissions string, which is in the first column.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO8-5)  
Verify the file size, which is in the fifth column. Directory sizes are not tested, so this is an optional argument.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO8-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO9-1)  
Create a `PathBuf` value for *tests/inputs/bustle.txt*.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO9-2)  
Execute the function with one path.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO9-3)  
Break the output on newlines and verify there is just one line.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO9-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO10-1)  
Execute the function with two arguments, one of which is a directory.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO10-2)  
Verify that two lines are returned.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO10-3)  
Verify the expected values for the *empty.txt* file.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO10-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO11-1)  
Initialize a mutable vector for the results.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO11-2)  
Attempt to get the metadata for the path.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO11-3)  
In the event of an error such as a nonexistent file, print an error message to `STDERR` and move to the next file.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO11-4)  
Check if the entry is a directory.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO11-5)  
If so, use `fs::read_dir` to read the entries.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO11-6)  
Unpack the `Result`.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_elless_island_CO11-7)  
Use [`DirEntry::path`](https://oreil.ly/koDWO) to get the `Path` value for the entry.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_elless_island_CO11-8)  
Check if the basename starts with a dot and is therefore hidden.

[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_elless_island_CO11-9)  
If the entry should be displayed, add a `PathBuf` to the results.

[![10](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/10.png)](#co_elless_island_CO11-10)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO12-1)  
An owner can be a user, group, or other.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO12-2)  
This is an implementation (`impl`) block for `Owner`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO12-3)  
Define a method called `masks` that will return an array of the mask values for a given owner.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO12-4)  
`self` will be one of the `enum` variants.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO12-5)  
These are the read, write, and execute masks for `User`.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO12-6)  
These are the read, write, and execute masks for `Group`.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_elless_island_CO12-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO13-1)  
The function takes a permissions `mode` and an `Owner`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO13-2)  
Unpack the three mask values for this `owner`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO13-3)  
Use the `format!` macro to create a new `String` to return.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO13-4)  
If the `mode` masked with the `read` value returns `0`, then the *read* bit is not set. Show a dash (`-`) when unset and `r` when set.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO13-5)  
Likewise, mask the `mode` with the `write` value and display `w` if set and a dash otherwise.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO13-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO14-1)  
The function takes a `u32` value and returns a new string.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO14-2)  
The returned string will be made of three triple values, like `rwx`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO14-3)  
...
![clru 1405](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_1405.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO15-1)  
Create a new [`tabular::Table`](https://oreil.ly/z73wW) using the given format string.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO15-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO15-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO15-4)  
Do likewise for the group ID and name.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO15-5)  
Choose whether to print a `d` if the entry is a directory or a dash (`-`) otherwise.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO15-6)  
Use the `format_mode` function to format the entry’s permissions.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_elless_island_CO15-7)  
Create a `DateTime` struct using the metadata’s [`modified` value](https://oreil.ly/buVC9).

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_elless_island_CO15-8)  
Add a new [`Row`](https://oreil.ly/Mrmvg) to the table using the given cells.

[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_elless_island_CO15-9)  
Use [`metadata::nlink`](https://oreil.ly/f2RyC) to find the number of links.

[![10](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/10.png)](#co_elless_island_CO15-10)  
Use [`metadata::len`](https://oreil.ly/129cs) to get the size.

[![11](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/11.png)](#co_elless_island_CO15-11)  
Use [`strftime` format options](https://oreil.ly/075dF) to display the modification time.

[![12](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/12.png)](#co_elless_island_CO15-12)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO16-1)  
Find all the entries in the given list of files and directories.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO16-2)  
If the user wants the long listing, print the results of `format_output`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO16-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO17-1)  
The function accepts the filename and the expected permissions and size.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO17-2)  
Run `lsr` with the `--long` option for the given filename.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO17-3)  
Convert `STDOUT` to UTF-8.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO17-4)  
Break the output on whitespace and collect it into a vector.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO17-5)  
Check that the first column is the expected permissions.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO17-6)  
Check that the fifth column is the expected size.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_elless_island_CO17-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO18-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO18-2)  
The function accepts the arguments and a slice of tuples with the expected results.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO18-3)  
Run `lsr` with the given arguments and assert it is successful.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO18-4)  
Convert `STDOUT` to a string.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_elless_island_CO18-5)  
Break `STDOUT` into lines, ignoring any empty lines.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_elless_island_CO18-6)  
Check that the number of lines matches the expected number.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_elless_island_CO18-7)  
Initialize a mutable vector of items to check.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_elless_island_CO18-8)  
Break the line on whitespace and extract the path, permissions, and size.

[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_elless_island_CO18-9)  
Ignore the size of directories.

[![10](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/10.png)](#co_elless_island_CO18-10)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_elless_island_CO19-1)  
These are the arguments to `lsr`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_elless_island_CO19-2)  
The *empty.txt* file should have permissions of `644` and a file size of `0`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_elless_island_CO19-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_elless_island_CO19-4)  
