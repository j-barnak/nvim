...
[![1](media/assets/1.png)](#co_test_for_echo_CO1-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO2-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO3-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO4-1)  
Import the `clap::Command` struct.

[![2](media/assets/2.png)](#co_test_for_echo_CO4-2)  
Create a new `Command` with the name `echor`.

[![3](media/assets/3.png)](#co_test_for_echo_CO4-3)  
Use semantic version information.

[![4](media/assets/4.png)](#co_test_for_echo_CO4-4)  
Include your name and email address so people know where to send the money.

[![5](media/assets/5.png)](#co_test_for_echo_CO4-5)  
This is a short description of the program.

[![6](media/assets/6.png)](#co_test_for_echo_CO4-6)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO5-1)  
Import `Arg`, `ArgAction`, and `Command` from the `clap` crate.

[![2](media/assets/2.png)](#co_test_for_echo_CO5-2)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO6-1)  
The required input text is one or more positional arguments.

[![2](media/assets/2.png)](#co_test_for_echo_CO6-2)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO7-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO8-1)  
Assume a default value of the newline.

[![2](media/assets/2.png)](#co_test_for_echo_CO8-2)  
Change the value to the empty string if the newline should be omitted.

[![3](media/assets/3.png)](#co_test_for_echo_CO8-3)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO9-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO10-1)  
The `predicates` crate helps to check the program’s output.

[![2](media/assets/2.png)](#co_test_for_echo_CO10-2)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO11-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO12-1)  
...
[![2](media/assets/2.png)](#co_test_for_echo_CO12-2)  
Define a variable for the output directory.

[![3](media/assets/3.png)](#co_test_for_echo_CO12-3)  
Test if the output directory does not exist and create it if needed.

[![4](media/assets/4.png)](#co_test_for_echo_CO12-4)  
One argument with two words.

[![5](media/assets/5.png)](#co_test_for_echo_CO12-5)  
Two arguments separated by more than one space.

[![6](media/assets/6.png)](#co_test_for_echo_CO12-6)  
One argument with two spaces and no newline.

[![7](media/assets/7.png)](#co_test_for_echo_CO12-7)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO13-1)  
This is the output from `echo` generated by *mk-outs.sh*.

[![2](media/assets/2.png)](#co_test_for_echo_CO13-2)  
...
[![3](media/assets/3.png)](#co_test_for_echo_CO13-3)  
Create a `Command` to run `echor` in the current crate.

[![4](media/assets/4.png)](#co_test_for_echo_CO13-4)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO15-1)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO17-1)  
...
[![2](media/assets/2.png)](#co_test_for_echo_CO17-2)  
Run the program with two strings as input.

[![3](media/assets/3.png)](#co_test_for_echo_CO17-3)  
...
[![4](media/assets/4.png)](#co_test_for_echo_CO17-4)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO18-1)  
Import the [`clap::Parser`](https://oreil.ly/IrHOL) trait.

[![2](media/assets/2.png)](#co_test_for_echo_CO18-2)  
...
[![3](media/assets/3.png)](#co_test_for_echo_CO18-3)  
...
[![4](media/assets/4.png)](#co_test_for_echo_CO18-4)  
This doc comment becomes the program’s *about* description.

[![5](media/assets/5.png)](#co_test_for_echo_CO18-5)  
Define a struct called `Args`.

[![6](media/assets/6.png)](#co_test_for_echo_CO18-6)  
...
[![7](media/assets/7.png)](#co_test_for_echo_CO18-7)  
...
[![8](media/assets/8.png)](#co_test_for_echo_CO18-8)  
Define a short flag `-n` for the following argument.

[![9](media/assets/9.png)](#co_test_for_echo_CO18-9)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO19-1)  
Parse the command-line arguments into a `Args` struct.

[![2](media/assets/2.png)](#co_test_for_echo_CO19-2)  
...
[![1](media/assets/1.png)](#co_test_for_echo_CO20-1)  
The field `args.text` provides access to a `Vec<String>`.

[![2](media/assets/2.png)](#co_test_for_echo_CO20-2)  
