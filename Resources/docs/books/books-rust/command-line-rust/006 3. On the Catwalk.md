...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO1-1)  
This is the output from the first file.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO1-2)  
This is the error for a nonexistent file.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO1-3)  
This is the output from the third file.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO1-4)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO2-1)  
Change into the *tests/inputs* directory.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO2-2)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO4-1)  
This function returns an `Args` struct.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO4-2)  
Define the program’s arguments here.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO4-3)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO5-1)  
Attempt to parse the command-line arguments.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO5-2)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO6-1)  
The `files` argument should default to a vector containing a single dash (`-`) for `STDIN`.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO6-2)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO7-1)  
The positional file argument is parsed into the `files`.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO7-2)  
...
[![5](media/assets/5.png)](#co_on_the_catwalk_CO8-5)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO9-1)  
The function takes the `Args` struct and returns a `Result`.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO9-2)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO10-1)  
Call `run` with the results of `get_args` and catch the `Err` variant.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO10-2)  
Print the error message `e` to `STDERR`.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO10-3)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO11-1)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO12-1)  
Iterate through each filename.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO12-2)  
Print the filename.
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO14-1)  
Iterate through the filenames.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO14-2)  
Try to open the filename. Note the use of `&` to borrow the variable.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO14-3)  
Print an error message to `STDERR` when `open` fails.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO14-4)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO16-1)  
...
[![2](media/assets/2.png)](#co_on_the_catwalk_CO16-2)  
Start an infinite `loop`.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO16-3)  
Create a random string of seven alphanumeric characters.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO16-4)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO18-1)  
...
[![2](media/assets/2.png)](#co_on_the_catwalk_CO18-2)  
Try to read the expected output file.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO18-3)  
Execute the program with the arguments and obtain the output.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO18-4)  
Verify the program ran successfully.

[![5](media/assets/5.png)](#co_on_the_catwalk_CO18-5)  
Attempt to convert the program’s `STDOUT` to a string.

[![6](media/assets/6.png)](#co_on_the_catwalk_CO18-6)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO19-1)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO20-1)  
The first argument is the filename containing the text that should be given to `STDIN`.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO20-2)  
Try to read the input and expected files.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO20-3)  
Try to run the program with the given arguments and `STDIN`.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO20-4)  
Verify that the program ran successfully.

[![5](media/assets/5.png)](#co_on_the_catwalk_CO20-5)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO21-1)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO23-1)  
Initialize a mutable counter variable to hold the line number.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO23-2)  
Add 1 to the line number.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO23-3)  
Check if the user wants line numbers.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO23-4)  
...
[![5](media/assets/5.png)](#co_on_the_catwalk_CO23-5)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO24-1)  
The tuple values from `Iterator::enumerate` can be unpacked using pattern matching.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO24-2)  
...
[![1](media/assets/1.png)](#co_on_the_catwalk_CO25-1)  
Initialize a mutable variable for the number of the last nonblank line.

[![2](media/assets/2.png)](#co_on_the_catwalk_CO25-2)  
Shadow the `line` with the result of unpacking the `Result`.

[![3](media/assets/3.png)](#co_on_the_catwalk_CO25-3)  
Handle printing line numbers.

[![4](media/assets/4.png)](#co_on_the_catwalk_CO25-4)  
Handle printing line numbers for nonblank lines.

[![5](media/assets/5.png)](#co_on_the_catwalk_CO25-5)  
If the line is empty, print a blank line.

[![6](media/assets/6.png)](#co_on_the_catwalk_CO25-6)  
Otherwise, increment `prev_num` and print the output.

[![7](media/assets/7.png)](#co_on_the_catwalk_CO25-7)  
