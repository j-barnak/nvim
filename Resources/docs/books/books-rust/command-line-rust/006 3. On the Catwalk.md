...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO1-1)  
This is the output from the first file.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO1-2)  
This is the error for a nonexistent file.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO1-3)  
This is the output from the third file.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO1-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO2-1)  
Change into the *tests/inputs* directory.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO2-2)  
...
![clru 0301](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_0301.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO3-1)  
The [`derive` macro](https://oreil.ly/Lr8JE) adds the [`Debug` trait](https://oreil.ly/cEl5P) so the struct can be printed.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO3-2)  
Define a struct called `Args`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO3-3)  
The `files` will be a vector of strings.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO3-4)  
This is a Boolean value to indicate whether or not to print the line numbers.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_on_the_catwalk_CO3-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO4-1)  
This function returns an `Args` struct.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO4-2)  
Define the program’s arguments here.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO4-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO5-1)  
Attempt to parse the command-line arguments.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO5-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO6-1)  
The `files` argument should default to a vector containing a single dash (`-`) for `STDIN`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO6-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO7-1)  
The positional file argument is parsed into the `files`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO7-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO8-1)  
This positional argument is for the files and is required to have at least one value that defaults to a dash (`-`).

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO8-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO8-3)  
The `-b|--number-nonblank` flag controls whether or not to print line numbers for nonblank lines.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO8-4)  
...
[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_on_the_catwalk_CO8-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO9-1)  
The function takes the `Args` struct and returns a `Result`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO9-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO10-1)  
Call `run` with the results of `get_args` and catch the `Err` variant.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO10-2)  
Print the error message `e` to `STDERR`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO10-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO11-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO12-1)  
Iterate through each filename.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO12-2)  
Print the filename.
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO13-1)  
The function will accept a filename and will return either an error or a boxed value that implements the `BufRead` trait.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO13-2)  
When the filename is a dash (`-`), read from [`std::io::stdin`](https://oreil.ly/TtQvx).

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO13-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO14-1)  
Iterate through the filenames.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO14-2)  
Try to open the filename. Note the use of `&` to borrow the variable.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO14-3)  
Print an error message to `STDERR` when `open` fails.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO14-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO15-1)  
All programs will use `anyhow::Result` over the default `Result`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO15-2)  
All tests will use `pretty_assertions::assert_eq` over the default `assert_eq!` macro.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO15-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO16-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO16-2)  
Start an infinite `loop`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO16-3)  
Create a random string of seven alphanumeric characters.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO16-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO17-1)  
Generate the name of a nonexistent file.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO17-2)  
The expected error message should include the filename and the string *os error 2* on both Windows and Unix platforms.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO17-3)  
Run the program with the bad file and verify that `STDERR` matches the expected pattern.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO17-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO18-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO18-2)  
Try to read the expected output file.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO18-3)  
Execute the program with the arguments and obtain the output.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO18-4)  
Verify the program ran successfully.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_on_the_catwalk_CO18-5)  
Attempt to convert the program’s `STDOUT` to a string.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_on_the_catwalk_CO18-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO19-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO20-1)  
The first argument is the filename containing the text that should be given to `STDIN`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO20-2)  
Try to read the input and expected files.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO20-3)  
Try to run the program with the given arguments and `STDIN`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO20-4)  
Verify that the program ran successfully.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_on_the_catwalk_CO20-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO21-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO22-1)  
Print the filename and error when there is a problem opening a file.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO22-2)  
Iterate over each `line_result` value from `BufRead::lines`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO22-3)  
Either unpack an `Ok` value from `line_result` or propagate an error.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO22-4)  
Print the line.
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO23-1)  
Initialize a mutable counter variable to hold the line number.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO23-2)  
Add 1 to the line number.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO23-3)  
Check if the user wants line numbers.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO23-4)  
...
[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_on_the_catwalk_CO23-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO24-1)  
The tuple values from `Iterator::enumerate` can be unpacked using pattern matching.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO24-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_on_the_catwalk_CO25-1)  
Initialize a mutable variable for the number of the last nonblank line.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_on_the_catwalk_CO25-2)  
Shadow the `line` with the result of unpacking the `Result`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_on_the_catwalk_CO25-3)  
Handle printing line numbers.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_on_the_catwalk_CO25-4)  
Handle printing line numbers for nonblank lines.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_on_the_catwalk_CO25-5)  
If the line is empty, print a blank line.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_on_the_catwalk_CO25-6)  
Otherwise, increment `prev_num` and print the output.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_on_the_catwalk_CO25-7)  
