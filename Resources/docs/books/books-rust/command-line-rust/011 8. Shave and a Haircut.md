...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO1-1)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO2-1)  
Exactly one of `--fields`, `--bytes`, or `--chars` is required.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO2-2)  
The input files are optional, and the default is `STDIN` as denoted by a dash.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO2-3)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO3-1)  
The `files` parameter is a vector of strings.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO3-2)  
The `delimiter` is the character separating the columns.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO3-3)  
The `extract` field points to a separate struct.

[![4](media/assets/4.png)](#co_shave_and_a_haircut_CO3-4)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO4-1)  
The default file input is a dash.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO4-2)  
The default delimiter is a tab.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO4-3)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO5-1)  
The positional argument is parsed into the `files` field.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO5-2)  
The `-d` argument is parsed into the `delimiter` field.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO5-3)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO6-1)  
The `files` argument is positional, not required, and defaults to a dash.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO6-2)  
The `delimiter` option defaults to a tab.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO6-3)  
`fields` is optional.

[![4](media/assets/4.png)](#co_shave_and_a_haircut_CO6-4)  
`bytes` is optional.

[![5](media/assets/5.png)](#co_shave_and_a_haircut_CO6-5)  
`chars` is optional.

[![6](media/assets/6.png)](#co_shave_and_a_haircut_CO6-6)  
This creates an argument group that requires exactly one of the members.

[![7](media/assets/7.png)](#co_shave_and_a_haircut_CO6-7)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO8-1)  
The program is run with two commas for the delimiter.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO8-2)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO10-1)  
A `PositionList` is a vector of `Range<usize>` values.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO10-2)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO11-1)  
This function accepts a `String` and will either return a `PositionList` or an error.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO11-2)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO12-1)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO13-1)  
Create a closure that accepts no arguments and formats an error string.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO13-2)  
Check if the input value starts with a plus sign.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO13-3)  
If so, create an error.

[![4](media/assets/4.png)](#co_shave_and_a_haircut_CO13-4)  
Otherwise, continue with the following closure, which accepts no arguments.

[![5](media/assets/5.png)](#co_shave_and_a_haircut_CO13-5)  
...
[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO14-3)  
Map each split value into the closure.

[![4](media/assets/4.png)](#co_shave_and_a_haircut_CO14-4)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO15-1)  
...
[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO15-2)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO16-1)  
...
[![5](media/assets/5.png)](#co_shave_and_a_haircut_CO17-5)  
The [`Reader::records` method](https://oreil.ly/SDfZC) provides access to an iterator over `StringRecord` values.

[![6](media/assets/6.png)](#co_shave_and_a_haircut_CO17-6)  
Print a formatted version of the record.

[![7](media/assets/7.png)](#co_shave_and_a_haircut_CO17-7)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO18-1)  
...
[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO18-2)  
Initialize a mutable vector to hold the selected characters.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO18-3)  
Iterate over each `Range` of indexes.

[![4](media/assets/4.png)](#co_shave_and_a_haircut_CO18-4)  
Iterate over each value in the `Range`.

[![5](media/assets/5.png)](#co_shave_and_a_haircut_CO18-5)  
...
[![6](media/assets/6.png)](#co_shave_and_a_haircut_CO18-6)  
...
[![7](media/assets/7.png)](#co_shave_and_a_haircut_CO18-7)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO19-1)  
Use [`Iterator::map`](https://oreil.ly/cfevE) to process each `Range` to select the characters.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO19-2)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO20-1)  
Break the line into a vector of bytes.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO20-2)  
Use `Iterator::flat_map` to select bytes at the wanted positions and copy the selected bytes.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO20-3)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO21-1)  
Use [`StringRecord::get`](https://oreil.ly/pIQuO) to try to get the field for the index position.

[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO21-2)  
...
[![1](media/assets/1.png)](#co_shave_and_a_haircut_CO22-1)  
...
[![2](media/assets/2.png)](#co_shave_and_a_haircut_CO22-2)  
Use `csv::WriterBuilder` to correctly escape delimiters in the output.

[![3](media/assets/3.png)](#co_shave_and_a_haircut_CO22-3)  
Iterate through the records.

[![4](media/assets/4.png)](#co_shave_and_a_haircut_CO22-4)  
Write the extracted fields to the output.

[![5](media/assets/5.png)](#co_shave_and_a_haircut_CO22-5)  
Iterate the lines of text and print the extracted bytes.

[![6](media/assets/6.png)](#co_shave_and_a_haircut_CO22-6)  
