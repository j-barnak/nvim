...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO1-1)  
`files` will be a vector of strings.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO1-2)  
The number of `lines` to print will be of the type [`u64`](https://oreil.ly/fY3qc).

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO1-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO2-1)  
`files` should default to a dash (`-`) as the filename.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO2-2)  
The number of `lines` should default to `10`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO2-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO3-1)  
The positional argument *tests/inputs/one.txt* is parsed as one of the `files`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO3-2)  
The `-n` option for `lines` sets this to `3`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO3-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO4-1)  
There are four files ending in *.txt*.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO4-2)  
`lines` is still set to the default value of `10`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO4-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO5-1)  
The `lines` option takes a value and defaults to `10`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO5-2)  
The `bytes` option takes a value, and it conflicts with the `lines` parameter so that they are mutually exclusive.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO5-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO6-1)  
Iterate through each of the filenames.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO6-2)  
Attempt to open the given file.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO6-3)  
Print errors to `STDERR`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_head_aches_CO6-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO7-1)  
This is an empty file just to ensure your program doesn’t fall over.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO7-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO7-3)  
This file has Windows-style line endings.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_head_aches_CO7-4)  
This file has 12 lines to ensure the default of 10 lines is shown.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_head_aches_CO7-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO8-1)  
Use [`Iterator::take`](https://oreil.ly/OjTMN) to select the desired number of lines from the filehandle.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO8-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO9-1)  
Accept the filehandle as a mutable value.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO9-2)  
Use [`String::new`](https://oreil.ly/Lg0D2) to create a new, empty mutable string buffer to hold each line.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO9-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_head_aches_CO9-4)  
Use [`BufRead::read_line`](https://oreil.ly/aJFkc) to read the next line into the string buffer.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_head_aches_CO9-5)  
The filehandle will return zero bytes when it reaches the end of the file, so [`break`](https://oreil.ly/UG54e) out of the loop.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_head_aches_CO9-6)  
Print the line, including the original line ending.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_head_aches_CO9-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO10-1)  
Use pattern matching to check if `args.bytes` is `Some` number of bytes to read.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO10-2)  
Create a mutable buffer of a fixed length `num_bytes` filled with zeros to hold the bytes read from the file.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO10-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_head_aches_CO10-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO11-1)  
Create a new string buffer to hold the contents of the file.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO11-2)  
Read the entire file contents into the string buffer.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO11-3)  
Use [`str::as_bytes`](https://oreil.ly/JaIiI) to convert the contents into bytes (`u8` or unsigned 8-bit integers).

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_head_aches_CO11-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO12-1)  
Handle any invalid UTF-8 in `expected_file`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO12-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_head_aches_CO13-1)  
Use the [`Vec::len` method](https://oreil.ly/e0wqL) to get the number of files.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_head_aches_CO13-2)  
Use the `Iterator::enumerate` method to track the file number and filenames.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_head_aches_CO13-3)  
Only print headers when there are multiple files.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_head_aches_CO13-4)  
