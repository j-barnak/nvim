...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO1-1)  
The first input filename is a `String`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO1-2)  
The second input filename is a `String`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO1-3)  
A Boolean for whether or not to show the first column of output.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_boston_commons_CO1-4)  
A Boolean for whether or not to show the second column of output.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_boston_commons_CO1-5)  
A Boolean for whether or not to show the third column of output.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_boston_commons_CO1-6)  
A Boolean for whether or not to perform case-insensitive comparisons.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_boston_commons_CO1-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO2-1)  
The two positional arguments are parsed into `file1` and `file2`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO2-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO3-1)  
The `-123` sets each of the *show* values to `false`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO3-2)  
The `-i` sets `insensitive` to `true`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO3-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO4-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO5-1)  
Check that both of the filenames are not a dash (`-`).

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO5-2)  
Attempt to open the two input files.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO5-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO6-1)  
Create a closure to lowercase each line of text when `args.insensitive` is `true`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO6-2)  
Open the files, create iterators that remove errors, and then map the lines through the `case` closure.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO6-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_boston_commons_CO6-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO7-1)  
Make the line variables mutable.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO7-2)  
Execute the loop as long as one of the filehandles produces a line.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO7-3)  
Compare all possible combinations of the two line variables for two variants.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_boston_commons_CO7-4)  
When both are `Some` values, use `Iterator::next` to retrieve the next line from both filehandles.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_boston_commons_CO7-5)  
When there is only the first value, ask for the next line from the first filehandle.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_boston_commons_CO7-6)  
Do the same for the second filehandle.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_boston_commons_CO7-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO8-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO9-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO9-2)  
When the two values are equal, print the first and get values from each of the files.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO9-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_boston_commons_CO9-4)  
...
[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_boston_commons_CO9-5)  
When there is a value only from the first file, print it and continue requesting values from the first file.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_boston_commons_CO9-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO10-1)  
Create a mutable vector to hold the output columns.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO10-2)  
Given text for column 1, add the value only if the column is shown.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO10-3)  
Given text for column 2, add the values for the two columns only if they are shown.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_boston_commons_CO10-4)  
Given text for column 3, add the values for the three columns only if they are shown.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_boston_commons_CO10-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_boston_commons_CO11-1)  
Draw the initial values from the two input files.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_boston_commons_CO11-2)  
When the values are the same, print one of them in column 3.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_boston_commons_CO11-3)  
When the first value is less than the second, print the first value in column 1.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_boston_commons_CO11-4)  
When the first value is greater than the second, print the second value in col­umn 2.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_boston_commons_CO11-5)  
When there is a value only from the first file, print it in column 1.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_boston_commons_CO11-6)  
