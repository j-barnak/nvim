...
[![1](media/assets/1.png)](#co_boston_commons_CO2-1)  
The two positional arguments are parsed into `file1` and `file2`.

[![2](media/assets/2.png)](#co_boston_commons_CO2-2)  
...
[![1](media/assets/1.png)](#co_boston_commons_CO3-1)  
The `-123` sets each of the *show* values to `false`.

[![2](media/assets/2.png)](#co_boston_commons_CO3-2)  
The `-i` sets `insensitive` to `true`.

[![3](media/assets/3.png)](#co_boston_commons_CO3-3)  
...
[![1](media/assets/1.png)](#co_boston_commons_CO4-1)  
...
[![1](media/assets/1.png)](#co_boston_commons_CO5-1)  
Check that both of the filenames are not a dash (`-`).

[![2](media/assets/2.png)](#co_boston_commons_CO5-2)  
Attempt to open the two input files.

[![3](media/assets/3.png)](#co_boston_commons_CO5-3)  
...
[![4](media/assets/4.png)](#co_boston_commons_CO6-4)  
...
[![1](media/assets/1.png)](#co_boston_commons_CO8-1)  
...
[![1](media/assets/1.png)](#co_boston_commons_CO9-1)  
...
[![2](media/assets/2.png)](#co_boston_commons_CO9-2)  
When the two values are equal, print the first and get values from each of the files.

[![3](media/assets/3.png)](#co_boston_commons_CO9-3)  
...
[![4](media/assets/4.png)](#co_boston_commons_CO9-4)  
