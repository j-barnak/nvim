...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO1-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO2-1)  
The `pattern` is a required string.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO2-2)  
The `files` option is a vector of strings.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO2-3)  
The `insensitive` option is a Boolean for whether or not to match with case sensitivity.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_jack_the_grepper_CO2-4)  
The `recursive` option is a Boolean for whether or not to recursively search directories.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_jack_the_grepper_CO2-5)  
The `count` option is a Boolean for whether or not to display a count of the matches.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_jack_the_grepper_CO2-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO3-1)  
The search pattern is a required argument.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO3-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO4-1)  
The first positional argument is for the `pattern`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO4-2)  
The rest of the positional arguments are for the inputs. The default is a dash.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO4-3)  
The `insensitive` flag will handle case-insensitive options.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_jack_the_grepper_CO4-4)  
The `recursive` flag will handle searching for files in directories.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_jack_the_grepper_CO4-5)  
The `count` flag will cause the program to print counts.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_jack_the_grepper_CO4-6)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO5-1)  
The [`RegexBuilder::new` method](https://oreil.ly/Aw1Hk) will create a new regular expression.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO5-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO5-3)  
The [`RegexBuilder::build` method](https://oreil.ly/LbZh5) will compile the regex.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_jack_the_grepper_CO5-4)  
...
[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_jack_the_grepper_CO5-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO6-1)  
The `file` option must implement the [`std::io::BufRead` trait](https://oreil.ly/c5fGP).

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO6-2)  
The `pattern` argument is a reference to a compiled regular expression.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO6-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO7-1)  
Look for the input files.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO7-2)  
Handle the errors from finding input files.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO7-3)  
Try to open a valid filename.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_jack_the_grepper_CO7-4)  
Handle errors opening a file.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_jack_the_grepper_CO7-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO8-1)  
Initialize an empty vector to hold the `results`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO8-2)  
Iterate over each of the given paths.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO8-3)  
First, accept a dash (`-`) as a path, for `STDIN`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_jack_the_grepper_CO8-4)  
Try to get the path’s metadata.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_jack_the_grepper_CO8-5)  
Check if the path is a directory.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_jack_the_grepper_CO8-6)  
Check if the user wants to recursively search directories.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_jack_the_grepper_CO8-7)  
Add all the files in the given directory to the `results`.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_jack_the_grepper_CO8-8)  
...
[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_jack_the_grepper_CO8-9)  
Note an error that the given entry is a directory.

[![10](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/10.png)](#co_jack_the_grepper_CO8-10)  
If the path is a file, add it to the `results`.

[![11](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/11.png)](#co_jack_the_grepper_CO8-11)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO9-1)  
Initialize a mutable vector to hold the matching lines.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO9-2)  
Use the [`BitXor` *bit-wise exclusive OR*](https://oreil.ly/fwIFt) operator (`^`) to determine if the line should be included.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO9-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO10-1)  
Verify that the line matches and the user does not want to invert the match.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO10-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO11-1)  
Find all the inputs.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO11-2)  
Find the number of inputs.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO11-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_jack_the_grepper_CO12-1)  
Print errors like nonexistent files to `STDERR`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_jack_the_grepper_CO12-2)  
Attempt to open a file. This might fail due to permissions.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_jack_the_grepper_CO12-3)  
Print an error to `STDERR`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_jack_the_grepper_CO12-4)  
Attempt to find the matching lines of text.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_jack_the_grepper_CO12-5)  
Print errors to `STDERR`.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_jack_the_grepper_CO12-6)  
...
![clru 0901](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_0901.png)
