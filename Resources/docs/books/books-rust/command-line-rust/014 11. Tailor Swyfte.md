...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO1-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO2-1)  
`files` is a vector of strings.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO2-2)  
`lines` should default to “10” to indicate the last 10 lines.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO2-3)  
`bytes` is an optional number of bytes to select.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO2-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO3-1)  
The positional argument goes into `files`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO3-2)  
The `lines` argument should default to “10” to take the last 10 lines.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO3-3)  
The `bytes` argument should default to `None`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO3-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO4-1)  
The positional arguments are parsed as `files`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO4-2)  
The `lines` argument is still set to the default.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO4-3)  
Now `bytes` is set to `Some("4")` to indicate the last four bytes should be taken.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO4-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO5-1)  
The `files` argument is positional and requires at least one value.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO5-2)  
The `lines` argument has a default value of `10`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO5-3)  
The `bytes` argument is optional and conflicts with `lines`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO5-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO6-1)  
The `PartialEq` is needed by the tests to compare values.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO6-2)  
This variant represents an argument of `+0`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO6-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO7-1)  
The `+5` argument indicates the program should start printing on the fifth line.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO7-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO8-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO9-1)  
Create a regex to find an optional leading `+` or `-` sign followed by one or more numbers.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO9-2)  
If the regex matches, the optional sign will be the first capture. Assume the minus sign if there is no match.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO9-3)  
The digits of the number will be in the second capture. Format the sign and digits into a string.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO9-4)  
Attempt to parse the number as an `i64`, which Rust infers from the function’s return type.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_tailor_swyfte_CO9-5)  
Check if the sign is a plus and the parsed value is `0`.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_tailor_swyfte_CO9-6)  
If so, return the `PlusZero` variant.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_tailor_swyfte_CO9-7)  
Otherwise, return the parsed value as the `TakeNum` variant.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_tailor_swyfte_CO9-8)  
Return the unparsable number as an error.

[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_tailor_swyfte_CO9-9)  
...
![clru 1101](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_1101.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO10-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO10-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO10-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO10-4)  
...
[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_tailor_swyfte_CO10-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO11-1)  
The `file` argument should implement the `BufRead` trait.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO11-2)  
The `num_lines` argument is a `TakeValue` describing the number of lines to print.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO11-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO12-1)  
The generic type `T` has the trait bounds `Read` and `Seek`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO12-2)  
The `file` argument must implement the indicated traits.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO12-3)  
The `num_bytes` argument is a `TakeValue` describing the byte selection.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO12-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO13-1)  
Create a mutable filehandle to read the given filename.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO13-2)  
Initialize counters for the number of lines and bytes as well as a buffer for reading the lines.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO13-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO13-4)  
When no bytes were read, exit the loop.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_tailor_swyfte_CO13-5)  
Increment the line count.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_tailor_swyfte_CO13-6)  
...
[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_tailor_swyfte_CO13-7)  
Clear the buffer before reading the next line.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_tailor_swyfte_CO13-8)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO14-1)  
When the user wants to start at index `0`, return `0` if the file is not empty; otherwise, return `None`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO14-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO14-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO14-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO15-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO15-2)  
Initialize variables for counting and reading lines from the file.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO15-3)  
Check if the given line is at or beyond the starting point.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO15-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO16-1)  
Count the total lines and bytes in the current file.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO16-2)  
Create a `BufReader` with the opened filehandle.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO16-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO17-1)  
See if there is a valid starting byte position.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO17-2)  
...
[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO17-3)  
Create a mutable buffer for reading the bytes.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO17-4)  
Read from the byte position to the end of the file and place the results into the buffer.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_tailor_swyfte_CO17-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO18-1)  
Check if the user has requested a byte selection.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO18-2)  
If so, print the selected bytes.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO18-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO19-1)  
Find the number of files.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO19-2)  
Use `Iterator::enumerate` to iterate through the index positions and filenames.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO19-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_tailor_swyfte_CO20-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_tailor_swyfte_CO20-2)  
The `real` time is *wall clock time*, measuring how long the process took from start to finish.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_tailor_swyfte_CO20-3)  
The `user` time is how long the CPU spent in *user* mode outside the kernel.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_tailor_swyfte_CO20-4)  
