...
![clru 0501](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/clru_0501.png)
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO1-1)  
The `-m` flag comes last, so characters are shown.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO1-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO2-1)  
Redirect output handle `2` (`STDERR`) to the file *err*.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO2-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO3-1)  
The `files` parameter will be a vector of strings.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO3-2)  
The `lines` parameter is a Boolean for whether or not to print the line count.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO3-3)  
The `words` parameter is a Boolean for whether or not to print the word count.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_word_to_your_mother_CO3-4)  
The `bytes` parameter is a Boolean for whether or not to print the byte count.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_word_to_your_mother_CO3-5)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO4-1)  
The default value for `files` should be a dash (`-`) for `STDIN`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO4-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO5-1)  
...
[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO5-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO6-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO7-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO8-1)  
When a file fails to open, print the filename and error message to `STDERR`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO8-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO9-1)  
The `count` function will accept a mutable `file` value, and it might return a `FileInfo` struct.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO9-2)  
Initialize mutable variables to count the lines, words, bytes, and characters.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO9-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO10-1)  
The [`cfg`](https://oreil.ly/Fl3pU) enables conditional compilation, so this module will be compiled only when testing.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO10-2)  
Define a new module (`mod`) called `tests`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO10-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_word_to_your_mother_CO10-4)  
Import `std::io::Cursor`.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_word_to_your_mother_CO10-5)  
Run `count` with the `Cursor`.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_word_to_your_mother_CO10-6)  
Ensure the result is `Ok`.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_word_to_your_mother_CO10-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO11-1)  
Create a mutable buffer to hold each `line` of text.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO11-2)  
Create an infinite `loop` for reading the filehandle.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO11-3)  
Try to read a line from the filehandle.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_word_to_your_mother_CO11-4)  
End of file (EOF) has been reached when zero bytes are read, so `break` out of the loop.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_word_to_your_mother_CO11-5)  
Add the number of bytes from this line to the `num_bytes` variable.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_word_to_your_mother_CO11-6)  
Each time through the loop is a line, so increment `num_lines` by one.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_word_to_your_mother_CO11-7)  
...
[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_word_to_your_mother_CO11-8)  
...
[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_word_to_your_mother_CO11-9)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO12-1)  
Attempt to get the counts from a file.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO12-2)  
Print the counts.
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO13-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO14-1)  
Try to read the `expected` output for this command.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO14-2)  
Run the `wcr` program with the given arguments and assert that the program succeeds.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO14-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO15-1)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO16-1)  
The function accepts a `usize` value and a Boolean and returns a `String`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO16-2)  
Check if the `show` value is `true`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO16-3)  
Return a new string by formatting the number into a string eight characters wide.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_word_to_your_mother_CO16-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO17-1)  
Add `format_field` to the imports.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO17-2)  
The function should return the empty string when `show` is `false`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO17-3)  
Check formatting for a single-digit number.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_word_to_your_mother_CO17-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO18-1)  
Format the output for each of the columns using the `format_field` function.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO18-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_word_to_your_mother_CO19-1)  
Create mutable variables to track the total number of lines, words, bytes, and characters.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_word_to_your_mother_CO19-2)  
Update the totals using the values from this file.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_word_to_your_mother_CO19-3)  
