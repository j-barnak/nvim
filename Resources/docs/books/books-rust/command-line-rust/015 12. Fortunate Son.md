...
[![1](media/assets/1.png)](#co_fortunate_son_CO2-1)  
Positional arguments should be interpreted as `sources`.

[![2](media/assets/2.png)](#co_fortunate_son_CO2-2)  
The `-m` option should be the value for the `pattern`.

[![3](media/assets/3.png)](#co_fortunate_son_CO2-3)  
The `insensitive` flag defaults to `false`.

[![4](media/assets/4.png)](#co_fortunate_son_CO2-4)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO3-1)  
`args.pattern` is an `Option<String>`.

[![2](media/assets/2.png)](#co_fortunate_son_CO3-2)  
Use [`Option::map`](https://oreil.ly/JaDYG) to handle `Some(val)`.

[![3](media/assets/3.png)](#co_fortunate_son_CO3-3)  
Call `RegexBuilder::new` with the given value.

[![4](media/assets/4.png)](#co_fortunate_son_CO3-4)  
...
[![5](media/assets/5.png)](#co_fortunate_son_CO3-5)  
The [`RegexBuilder::build` method](https://oreil.ly/wrXyO) will compile the regex.

[![6](media/assets/6.png)](#co_fortunate_son_CO3-6)  
...
[![7](media/assets/7.png)](#co_fortunate_son_CO3-7)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO4-1)  
Import `find_files`.

[![2](media/assets/2.png)](#co_fortunate_son_CO4-2)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO5-1)  
The `source` is the filename containing the record.

[![2](media/assets/2.png)](#co_fortunate_son_CO5-2)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO6-1)  
Import `read_fortunes`, `Fortune`, and `PathBuf` for testing.

[![2](media/assets/2.png)](#co_fortunate_son_CO6-2)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO7-1)  
Import the `pick_fortune` function for testing.

[![2](media/assets/2.png)](#co_fortunate_son_CO7-2)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO9-1)  
Create mutable vectors for the fortunes and a record buffer.

[![2](media/assets/2.png)](#co_fortunate_son_CO9-2)  
Iterate through the given filenames.

[![3](media/assets/3.png)](#co_fortunate_son_CO9-3)  
...
[![4](media/assets/4.png)](#co_fortunate_son_CO9-4)  
Open the file or return an error message.

[![5](media/assets/5.png)](#co_fortunate_son_CO9-5)  
Iterate through the lines of the file.

[![6](media/assets/6.png)](#co_fortunate_son_CO9-6)  
A sole percent sign (`%`) indicates the end of a record.

[![7](media/assets/7.png)](#co_fortunate_son_CO9-7)  
If the buffer is not empty, set the `text` to the buffer lines joined on newlines and then clear the buffer.

[![8](media/assets/8.png)](#co_fortunate_son_CO9-8)  
...
[![1](media/assets/1.png)](#co_fortunate_son_CO10-1)  
Create a PRNG using the provided seed.

[![2](media/assets/2.png)](#co_fortunate_son_CO10-2)  
Otherwise, use a PRNG seeded by the system.

[![3](media/assets/3.png)](#co_fortunate_son_CO10-3)  
