...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO1-1)  
The `sources` argument is a list of files or directories.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO1-2)  
The `pattern` is an optional string to filter fortunes.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO1-3)  
`insensitive` is a Boolean option for whether or not to search with case-sensitivity.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_fortunate_son_CO1-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO2-1)  
Positional arguments should be interpreted as `sources`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO2-2)  
The `-m` option should be the value for the `pattern`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO2-3)  
The `insensitive` flag defaults to `false`.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_fortunate_son_CO2-4)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO3-1)  
`args.pattern` is an `Option<String>`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO3-2)  
Use [`Option::map`](https://oreil.ly/JaDYG) to handle `Some(val)`.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO3-3)  
Call `RegexBuilder::new` with the given value.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_fortunate_son_CO3-4)  
...
[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_fortunate_son_CO3-5)  
The [`RegexBuilder::build` method](https://oreil.ly/wrXyO) will compile the regex.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_fortunate_son_CO3-6)  
...
[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_fortunate_son_CO3-7)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO4-1)  
Import `find_files`.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO4-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO5-1)  
The `source` is the filename containing the record.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO5-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO6-1)  
Import `read_fortunes`, `Fortune`, and `PathBuf` for testing.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO6-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO7-1)  
Import the `pick_fortune` function for testing.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO7-2)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO8-1)  
Create an `OsStr` value for the string *dat*.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO8-2)  
Create a mutable vector for the results.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO8-3)  
If [`fs::metadata`](https://oreil.ly/VsRxb) fails, return a useful error message.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_fortunate_son_CO8-4)  
Use [`Vec::extend`](https://oreil.ly/nWMcd) to add the results from `WalkDir` to the results.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_fortunate_son_CO8-5)  
Use [`walkdir::WalkDir`](https://oreil.ly/o6mZn) to find all the entries from the starting path.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_fortunate_son_CO8-6)  
This will ignore any errors for unreadable files or directories, which is the behavior of the original program.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_fortunate_son_CO8-7)  
Take only regular files that do not have the *.dat* extension.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_fortunate_son_CO8-8)  
The [`walkdir::DirEntry::path` function](https://oreil.ly/1dWxe) returns a `Path`, so convert it into a `PathBuf`.

[![9](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/9.png)](#co_fortunate_son_CO8-9)  
Use [`Vec::sort`](https://oreil.ly/ua40G) to sort the entries in place.

[![10](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/10.png)](#co_fortunate_son_CO8-10)  
Use [`Vec::dedup`](https://oreil.ly/7FvsZ) to remove consecutive repeated values.

[![11](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/11.png)](#co_fortunate_son_CO8-11)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO9-1)  
Create mutable vectors for the fortunes and a record buffer.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO9-2)  
Iterate through the given filenames.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO9-3)  
...
[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_fortunate_son_CO9-4)  
Open the file or return an error message.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_fortunate_son_CO9-5)  
Iterate through the lines of the file.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_fortunate_son_CO9-6)  
A sole percent sign (`%`) indicates the end of a record.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_fortunate_son_CO9-7)  
If the buffer is not empty, set the `text` to the buffer lines joined on newlines and then clear the buffer.

[![8](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/8.png)](#co_fortunate_son_CO9-8)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO10-1)  
Create a PRNG using the provided seed.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO10-2)  
Otherwise, use a PRNG seeded by the system.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO10-3)  
...
[![1](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/1.png)](#co_fortunate_son_CO11-1)  
Check if the user has provided a `pattern` option.

[![2](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/2.png)](#co_fortunate_son_CO11-2)  
Initialize a mutable variable to remember the last fortune source.

[![3](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/3.png)](#co_fortunate_son_CO11-3)  
Iterate over the found fortunes and filter for those matching the provided regular expression.

[![4](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/4.png)](#co_fortunate_son_CO11-4)  
Print the source header if the current source is not the same as the previous one seen.

[![5](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/5.png)](#co_fortunate_son_CO11-5)  
Store the current fortune source.

[![6](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/6.png)](#co_fortunate_son_CO11-6)  
Print the text of the fortune.

[![7](/tmp/audit/iter1/epubregen/command-line-rust/media/assets/7.png)](#co_fortunate_son_CO11-7)  
