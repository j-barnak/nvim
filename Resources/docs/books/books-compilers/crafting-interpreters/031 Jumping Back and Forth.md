...
![Flowchart of the compiled bytecode of an if statement.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/if-without-else.png)
...
![A patch containing a number being sewn onto a sheet of bytecode.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/patch.png)
...
![Flowchart of the compiled bytecode with the then branch incorrectly falling through to the else branch.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/bad-else.png)
...
![Flowchart of the compiled bytecode for an if with an else clause.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/if-else.png)
...
![Flowchart of the compiled bytecode including necessary pop instructions.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/full-if-else.png)
...
![Flowchart of the compiled bytecode of an 'and' expression.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/and.png)
...
![Flowchart of the compiled bytecode of a logical or expression.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/or.png)
...
![Flowchart of the compiled bytecode of a while statement.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/while.png)
...
![Flowchart of the compiled bytecode of a for statement.](/tmp/audit/iter1/epubregen/crafting-interpreters/media/image/jumping-back-and-forth/for.png)
