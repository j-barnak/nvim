...
| `fs`                                 | Change focus to \<window\> .                                                                             |
| help \<cmd\>                         | Display help text about \<cmd\> .                                                                        |
| `h`                                  | Display help text about \<cmd\> .                                                                        |
...
| `continue`                                                                      | `Resume the program.`                                                                                                                                                      |
| `c`                                                                             | `Resume the program.`                                                                                                                                                      |
| `process continue`                                                              | `Resume the program.`                                                                                                                                                      |
| `finish`                                                                        | `Resume the program and continue until the current function exits.`                                                                                                        |
| `fin`                                                                           | `Resume the program and continue until the current function exits.`                                                                                                        |
| `thread step-out`                                                               | `Resume the program and continue until the current function exits.`                                                                                                        |
| stepi \[-c \<n\> \]                                                             | Execute one instruction (or n instructions), stepping into function calls.                                                                                                 |
| `si`                                                                            | Execute one instruction (or n instructions), stepping into function calls.                                                                                                 |
| `thread step-inst`                                                              | Execute one instruction (or n instructions), stepping into function calls.                                                                                                 |
| nexti \[-c \<n\> \]                                                             | Execute one instruction (or n instructions), stepping over function calls.                                                                                                 |
| `ni`                                                                            | Execute one instruction (or n instructions), stepping over function calls.                                                                                                 |
| `thread step-inst-over`                                                         | Execute one instruction (or n instructions), stepping over function calls.                                                                                                 |
...
| `br s`                                                                          | Set a breakpoint at start of function \<fun\> or at address \<addr\> (conditional on \<cond\> , if provided).                                                              |
| `breakpoint set`                                                                | Set a breakpoint at start of function \<fun\> or at address \<addr\> (conditional on \<cond\> , if provided).                                                              |
...
| `br del`                                                                        | Delete all breakpoints (or the breakpoint specified by \<id\> ).                                                                                                           |
| `breakpoint delete`                                                             | Delete all breakpoints (or the breakpoint specified by \<id\> ).                                                                                                           |
| exp -f \<format\> -- \<expr\>                                                   | Evaluate \<expr\> and display the result in format \<format\> .                                                                                                            |
| `expression`                                                                    | Evaluate \<expr\> and display the result in format \<format\> .                                                                                                            |
...
| `me read`                                                                       | Print out memory in \<count\> chunks of \<size\> bytes, starting at address \<addr\> . Display \<num -per-line\> chunks on each line in format \<format\> .                |
...
| `di`                                                                            | Disassemble all instructions in function \<fun\> , or \<count\> instructions starting at address \<addr\> , or \<count\> instructions starting at the current instruction. |
| help \<cmd\>                                                                    | Display help text about \<cmd\> .                                                                                                                                          |
| `h`                                                                             | Display help text about \<cmd\> .                                                                                                                                          |
