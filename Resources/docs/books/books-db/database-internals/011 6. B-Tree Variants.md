...
![dbin 0601](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0601.png)
...
![dbin 0604](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0604.png)
...
![dbin 0605](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0605.png)
...
![dbin 0606](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0606.png)
...
![dbin 0607](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0607.png)
...
Split SMOs start by consolidating the logical contents of the splitting node, applying deltas to its base node, and creating a new page containing elements to the right of the split point. After this, the process proceeds in two steps [\[WANG18\]](app01.html#WANG18):
...
![dbin 0608](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0608.png)
...
![dbin 0609](/tmp/audit/iter1/epubregen/database-internals/media/assets/dbin_0609.png)
