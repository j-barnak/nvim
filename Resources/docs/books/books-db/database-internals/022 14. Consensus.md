...
One of the most popular and widely known implementations of the atomic broadcast is ZAB used by [Apache Zookeeper](https://databass.dev/links/67) \[HUNT10\] \[JUNQUEIRA11\], a hierarchical distributed key-value store, where it’s used to ensure the total order of events and atomic delivery necessary to maintain consistency between the replica states.
