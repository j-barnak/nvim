...
Alternatively, you can find all the references at [*https://github.com/ept/ddia2-references*](https://github.com/ept/ddia2-references), where we maintain up-to-date links.
...
We have a web page for this book, where we list errata, examples, and any additional information. You can access this page at [*https://oreil.ly/DesigningDataIntensiveApps2*](https://oreil.ly/DesigningDataIntensiveApps2).
