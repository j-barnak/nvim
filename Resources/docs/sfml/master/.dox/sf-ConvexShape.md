...
Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:45
...
**See also**: `[sf::Shape](sf-Shape.md#shape)`, `[sf::RectangleShape](sf-RectangleShape.md#rectangleshape)`, `[sf::CircleShape](sf-CircleShape.md#circleshape)`

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`ConvexShape`](#convexshape-1) | `function` | Declared here |
| [`setPointCount`](#setpointcount-1) | `function` | Declared here |
| [`getPointCount`](#getpointcount-1) | `function` | Declared here |
| [`setPoint`](#setpoint) | `function` | Declared here |
| [`getPoint`](#getpoint-1) | `function` | Declared here |
...
|--------|------|-------------|
|  | [`ConvexShape`](#convexshape-1) `explicit` | Default constructor. |
| `void` | [`setPointCount`](#setpointcount-1)  | Set the number of points of the polygon. |
| `std::size_t` | [`getPointCount`](#getpointcount-1) `virtual` `const` `nodiscard` `override` | Get the number of points of the polygon. |
| `void` | [`setPoint`](#setpoint)  | Set the position of a point. |
| [`Vector2f`](sf.md#vector2f) | [`getPoint`](#getpoint-1) `virtual` `const` `nodiscard` `override` | Get the position of a point. |
...
Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:54
...
|-----------|------|-------------|
| `pointCount` | `std::size_t` | Number of points of the polygon |
...
Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:67

Set the number of points of the polygon.

For the shape to be rendered as expected, `count` must be greater or equal to 3.

**See also**: `[getPointCount](#getpointcount-1)`

#### Parameters

| Parameter | Type | Description |
|-----------|------|-------------|
| `count` | `std::size_t` | New number of points of the polygon |
...
Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:77
...
**See also**: `[setPointCount](#setpointcount-1)`
...
Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:97
...
**See also**: `[getPoint](#getpoint-1)`

#### Parameters

| Parameter | Type | Description |
|-----------|------|-------------|
| `index` | `std::size_t` | Index of the point to change, in range [0 .. [getPointCount()](#getpointcount-1) - 1] |
| `point` | [`Vector2f`](sf.md#vector2f) | New position of the point |
...
Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:114
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `index` | `std::size_t` | Index of the point to get, in range [0 .. [getPointCount()](#getpointcount-1) - 1] |

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| std::vector< [`Vector2f`](sf.md#vector2f) > | [`m_points`](#m_points)  | Points composing the convex polygon. |
...
Type: std::vector< [`Vector2f`](sf.md#vector2f) >

Defined in /home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Graphics/ConvexShape.hpp:120
