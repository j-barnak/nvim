...
\hypertarget{SocketHandle_8hpp_source}{}\label{SocketHandle_8hpp_source}\index{/home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Network/SocketHandle.hpp@{/home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Network/SocketHandle.hpp}}
\mbox{\hyperlink{SocketHandle_8hpp}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ }
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#if\ defined(SFML\_SYSTEM\_WINDOWS)}}
...
\DoxyCodeLine{00038\ \{}
\DoxyCodeLine{00040\ \textcolor{comment}{//\ Low-\/level\ socket\ handle\ type,\ specific\ to\ each\ platform}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#if\ defined(SFML\_SYSTEM\_WINDOWS)}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacesf_a7403828dc19b7052b988d22c841ae92d}{SocketHandle}}\ =\ UINT\_PTR;}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacesf_a7403828dc19b7052b988d22c841ae92d}{SocketHandle}}\ =\ int;}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00051\ }
\DoxyCodeLine{00052\ \}\ \textcolor{comment}{//\ namespace\ sf}}
