...
\hypertarget{Main_8hpp_source}{}\label{Main_8hpp_source}\index{/home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Main.hpp@{/home/jared/.local/share/nvim/docs/sfml/master/include/SFML/Main.hpp}}
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#if\ defined(SFML\_SYSTEM\_IOS)}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{comment}{//\ On\ iOS,\ we\ have\ no\ choice\ but\ to\ have\ our\ own\ main,}}
\DoxyCodeLine{00036\ \textcolor{comment}{//\ so\ we\ need\ to\ rename\ the\ user\ one\ and\ call\ it\ later}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#define\ main\ sfmlMain}}
\DoxyCodeLine{00038\ }
