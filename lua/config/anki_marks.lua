...
vim.api.nvim_create_user_command("AnkiMarkTodo", function()
	set_mark_on_current_line(MARKS.TODO)
end, {})
vim.api.nvim_create_user_command("AnkiMarkDoing", function()
	set_mark_on_current_line(MARKS.DOING)
end, {})
vim.api.nvim_create_user_command("AnkiMarkDone", function()
	set_mark_on_current_line(MARKS.DONE)
end, {})
vim.api.nvim_create_user_command("AnkiUnmark", function()
	set_mark_on_current_line("")
end, {})
vim.api.nvim_create_user_command("AnkiClearMarks", function()
	clear_all_marks_in_buffer()
end, {})
