...
local VERSIONED = {
	...
	bcc = { url = simple.bcc.url },
	libbpf = { url = simple.libbpf.url },
	bpftrace = { url = simple.bpftrace.url },
	drgn = { url = simple.drgn.url },
	triton = { url = simple.triton.url },
	angr = { url = simple.angr.url },
	binja = { url = simple.binja.url },
	pyelftools = { url = simple.pyelftools.url },
	qbindiff = { url = simple.qbindiff.url },
